      ...
      <View>
        ...
        <Text style={{
          ...
          <Text style={{
             ...
             fontSize:15,
             fontWeight:'600',
            }}>{panamaetages.etage} </Text>
             
        </View>
        <Image style={styles.miniplan} source={panamaetages.image}>
      ...
      <View style={{
        ...
        <Text style={{
             color:colors.white ,
              ...
              fontWeight:'900',
              fontSize:15,
            }}>{panamaetages.price} </Text>
        </View>
       
      </View>
      </View>
      <View>
      <Image style={styles.imageplan} source={panamaetages.image}>
