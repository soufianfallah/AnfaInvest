...
import BasilicoStudios from '../../consts/BasilicoStudios';
import BasilicoStudiosA from '../../consts/BasilicoStudiosA';
...
const Basilico = ({route, navigation}) => {
  const Card = ({basilicoetages}) => {
    return (
      <TouchableOpacity
      style={styles.cardImage}
        activeOpacity={0.8}
        onPress={() => navigation.navigate('BasilicoDetails', basilicoetages)}>
  ...
  return (
    ...
    <View style={styles.container}>
      <ImageBackground source={basilico} style={styles.backgroundImage}>
        <TouchableOpacity
        ...
        <View style={styles.titlesWrapper}>
          <Text style={styles.itemTitle}>Basilico</Text>
          <View style={styles.locationWrapper}>
            <Entypo name="location-pin" size={24} color={colors.white} />
            <Text style={styles.locationText}>CIL – Casablanca</Text>
          </View>
        </View>
      </ImageBackground>
      ...
      <Text style={styles.sectionTitle}>LES STUDIOS BASILICO</Text>
     ...
     <Text style={styles.sectionTitle}>STUDIOS PAR ÉTAGE  </Text>
        <View>
        <Text style={styles.etageTitle}>1er/2eme ÉTAGE</Text>
          <FlatList
            contentContainerStyle={{paddingLeft: 20}}
            horizontal
            showsHorizontalScrollIndicator={false}
            data={BasilicoStudios}
            renderItem={({item}) => <Card basilicoetages={item} />}
          />
         <Text style={styles.etageTitle}>3eme/4eme/5eme ÉTAGE</Text>
          <FlatList
            contentContainerStyle={{paddingLeft: 20}}
            horizontal
            showsHorizontalScrollIndicator={false}
            data={BasilicoStudiosA}
            renderItem={({item}) => <Card basilicoetages={item} />}
          />
        </View>
