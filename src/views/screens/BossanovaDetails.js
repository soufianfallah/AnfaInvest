...
const sidelogo =require('./assets/bossanovalogo.png');
const wtsp =require('./assets/wtsp.png');
const pin =require('./assets/pin.jpg');
const BSdetailsScreen = ({navigation, route}) => {
  const bossanovaetages = route.params;
  return (
      ...
      <View>
        ...
        <Text style={{
          ...
          <Text style={{
             ...
             fontSize:15,
             fontWeight:'600',
            }}>{bossanovaetages.etage} </Text>
             
        </View>
        <Image style={styles.miniplan} source={bossanovaetages.image}>
      ...
      <View style={{
        ...
        <Text style={{
             color:colors.white ,
              ...
              fontWeight:'900',
              fontSize:15,
            }}>{bossanovaetages.price} </Text>
        </View>
       
      </View>
      </View>
      <View>
      <Image style={styles.imageplan} source={bossanovaetages.image}>
