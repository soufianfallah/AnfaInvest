...
const sidelogo =require('./assets/basilicologo.png');
const wtsp =require('./assets/wtsp.png');
const pin =require('./assets/pin.jpg');
const BdetailsScreen = ({navigation, route}) => {
  const basilicoetages = route.params;
  return (
      ...
      <View>
        ...
        <Text style={{
          ...
          <Text style={{
             ...
             fontSize:15,
             fontWeight:'600',
            }}>{basilicoetages.etage} </Text>
             
        </View>
        <Image style={styles.miniplan} source={basilicoetages.image}>
      ...
      <View style={{
        ...
        <Text style={{
             color:colors.white ,
              ...
              fontWeight:'900',
              fontSize:15,
            }}>{basilicoetages.price} </Text>
        </View>
       
      </View>
      </View>
      <View>
      <Image style={styles.imageplan} source={basilicoetages.image}>
