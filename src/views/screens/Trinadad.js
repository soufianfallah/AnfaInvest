...
import TrinidadStudios from '../../consts/TrinidadStudios';
const trinidad = require('../screens/assets/trinidadimage.jpg');
const map = require('../screens/assets/trinidadmap.jpg');
...
const Trinadad = ({route, navigation}) => {
  const Card = ({trinidadetages}) => {
    return (
      <TouchableOpacity
      style={styles.cardImage}
        activeOpacity={0.8}
        onPress={() => navigation.navigate('TrinidadDetails', trinidadetages)}>
  ...
  return (
    ...
    <View style={styles.container}>
      <ImageBackground source={trinidad} style={styles.backgroundImage}>
        <TouchableOpacity
        ...
        <View style={styles.titlesWrapper}>
          <Text style={styles.itemTitle}>Trinidad</Text>
          <View style={styles.locationWrapper}>
            <Entypo name="location-pin" size={24} color={colors.white} />
            <Text style={styles.locationText}>Palmiers – Casablanca</Text>
          </View>
        </View>
      </ImageBackground>
      ...
      <Text style={styles.sectionTitle}>LES STUDIOS TRINIDAD</Text>
      <View style={{width:'100%',alignSelf:'center',height:212,}}>
      <Video
        ref={video}
     ...
     <Text style={styles.sectionTitle}>STUDIOS PAR ÉTAGE  </Text>
        <View>
          <FlatList
            ...
            data={TrinidadStudios}
            renderItem={({item}) => <Card trinidadetages={item} />}
          />
